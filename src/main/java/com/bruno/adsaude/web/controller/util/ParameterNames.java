...
public class ParameterNames {
	...
	public static final String FECHA_INCIDENCIA= "fecha-incidencia";
	public static final String TIPO_SERVICIO = "tipo-servicio";
	public static final String TIPO_INCIDENCIA = "tipo-incidencia";
	public static final String ASISTENCIA_ID = "asistencia-id";
	public static final String ASISTIDO_ID = "asistido-id";
	public static final String EMPLEADO_ID = "empleado-id";
	...
	public static final String DESCRPCION_CONTRATO = "descripcion-contrato";
	public static final String SERVICIO_HIJA = "servicio-hija";
	public static final String FAMILIAR_ID = "familiar-id";
	public static final String ASISTIDO_AFECTADO = "asistido-afectado";
